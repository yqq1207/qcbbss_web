...
import VerifyCode from '../../components/ImageCode';
...
export default class Forget extends Component {
  ...
  render() {
    const { form, submitting, code, message } = this.props;
    const { getFieldDecorator } = form;
    const { count, prefix } = this.state;
    return (
      <div className={styles.main}>
        {this.renderAlert(code, message)}
        <h3>忘记密码</h3>
            ...
            <Row gutter={8}>
              <Col span={16}>
                {getFieldDecorator('code', {
                  ...
                  size="large"
                  placeholder="图形验证码"
                  onChange={this.changeImgCode}
                />)}
              </Col>
              <Col span={8}>
                <VerifyCode onClick={this.handleRefresh} src={this.state.src} />
              </Col>
            </Row>
          </FormItem>
          <FormItem>
            ...
            <Row gutter={8}>
              ...
              <Col span={8}>
                <Button
                  ...
                  onClick={this.onGetCaptchaMobel}
                >
                  {count ? `${count} s` : '获取验证码'}
                </Button>
              </Col>
