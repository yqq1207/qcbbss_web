...
import { Row, Col, Card, Form, Input, Button, Modal, Table, message, Badge } from 'antd';
...
export default class Services extends PureComponent {
  ...
  renderTable() {
    ...
    return (
      <PageHeaderLayout title="店铺通知" content="所有的店铺通知信息展示在下方" >
        <Card bordered={false}>
        ...
        <Card bordered={false}>
          ...
          >
            ...
            <FormItem {...formItemLayout} label="增值服务价格">
              ...
              })(<Input placeholder="请输增值服务的价格" addonAfter="元" />)}
            </FormItem>
