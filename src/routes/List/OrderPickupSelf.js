...
export default class TableList extends PureComponent {
          ...
          <Card bordered={false}>
            <DescriptionList size="large" title="订单详细" style={{ marginBottom: 32 }}>
              ...
              {/* <Description term="发货方式">
                {orderStatus[orderInfoData.userOrders.status] || '快递发货'}
              </Description>
              <Description term="租用时间">
                {orderTypeStatus[orderInfoData.userOrders.type] || '2018-05-22 至 2018-05-23'}
              </Description>
              <Description term="下单时间">
                {isViolationStatus[orderInfoData.userOrders.is_violation] || '2018-05-19 15:55:17'}
              </Description>
              <Description term="付款时间">
                {isRenewalStatus[orderInfoData.userOrders.is_renewal] || '暂无信息'}
              </Description>
              <Description term="发货时间">
                {paymentTypeStatus[orderInfoData.userOrders.payment_type] || '未发货'}
              </Description> */}
            </DescriptionList>
  ...
  render() {
    const { rule: { data }, loading, orderInfoData } = this.props;
